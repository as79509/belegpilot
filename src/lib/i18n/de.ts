export const de = {
  ...
  onboardingWizard: {
    ...
    step7: {
      ...
      autopilotMode: "Autopilot-Modus",
      reviewLevel: "Review-Stufe",
      stabilizationDays: "Geschätzte Stabilisierung",
      days: "Tage",
      phases: {
      ...
      completedDescription: "Der Mandant ist live. Sie können jetzt über das Dashboard arbeiten.",
