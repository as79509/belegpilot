export const de = {
  ...
  nav: {
    ...
    system: "System",
    upload: "Hochladen",
    uploadCtaTitle: "Belege hochladen",
    uploadCtaSubtitle: "{count} Belege diesen Monat hochgeladen",
    uploadReadOnlyTitle: "Belege ansehen",
    uploadReadOnlySubtitle: "Upload ist für Ihre Rolle nicht freigeschaltet.",
    tasksOpen: "Offene Aufgaben",
    processedDocuments: "Verarbeitete Belege",
    uploadedCount: "Hochgeladen",
    bexio: "Bexio",
  },
  greeting: {
  ...
  dashboard: {
    ...
    restrictedModules: "{count} Module eingeschränkt",
    quickLinks: {
    ...
    todayHeading: "Heute erledigen",
    todayCards: {
      needsReview: "Zur Prüfung",
      openTasks: "Offene Aufgaben",
      uploaded: "Hochgeladen",
      exportReady: "Zu exportieren",
    },
  ...
  documents: {
    ...
    uploadZoneFormats: "PDF, JPG, PNG, HEIC — max. 20 MB",
    ...
    reviewSummary: "{count} Belege zur Prüfung",
    reviewSummaryWithUploaded: "{count} Belege zur Prüfung, {uploaded} diese Woche hochgeladen",
    filtersExtended: {
      currency: "Währung",
      exportStatus: "Export-Status",
      confidence: "Konfidenz",
      documentType: "Belegtyp",
      confidenceHigh: "Hoch (>80%)",
      confidenceMedium: "Mittel (50-80%)",
      confidenceLow: "Niedrig (<50%)",
      exportDone: "Exportiert",
      exportPending: "Nicht exportiert",
    },
    table: {
      documentNumber: "Belegnr.",
      export: "Export",
      emptyDescription: "Laden Sie Belege hoch oder passen Sie die Filter an",
      exportFailed: "Export fehlgeschlagen",
      reprocessFailed: "Erneute Verarbeitung fehlgeschlagen",
      processingStartFailed: "Verarbeitung konnte nicht gestartet werden",
    },
    uploadZone: {
      dropActive: "Dateien hier ablegen",
      dropHint: "Mehrfach-Upload und Scanner-Ordner werden unterstützt",
      supportedTypes: "Unterstützte Dateitypen",
      folderUpload: "Ordner hochladen",
      folderHint: "Komplette Scanner- oder Mail-Ordner mit PDF, JPG, PNG oder HEIC importieren",
      folderUnsupportedFound: "{supported} Dateien gefunden ({unsupported} nicht unterstützt)",
      folderNoSupported: "Keine unterstützten Dateien im Ordner gefunden",
      progress: "{done} von {total} Dateien hochgeladen",
      uploadedSingle: "{count} Beleg hochgeladen",
      uploadedMultiple: "{count} Belege hochgeladen",
  ...
  suppliers: {
    ...
    creating: "Lieferant wird angelegt…",
    createSuccess: "Lieferant erstellt",
    createError: "Lieferant konnte nicht erstellt werden",
    name: "Name",
    ...
    detailSections: {
      ...
      documentDefaults: "Standardwerte für Belege",
      notes: "Notizen",
      documentsEmpty: "Keine Belege",
    },
    fields: {
      email: "E-Mail",
      phone: "Telefon",
    ...
    readOnlyDescription: "Lieferantendaten können mit Ihrer Rolle angesehen, aber nicht geändert werden.",
  ...
  quickActions: {
    ...
    supplierMissing: "Kein Lieferant verknüpft",
  },
  ...
  onboardingWizard: {
    ...
    firstUsefulState: "Mandant ist bereits nutzbar!",
    firstUsefulStateDescription: "Grunddaten und genug Belege vorhanden. Sie k\u00f6nnen den Wizard jederzeit fortsetzen.",
    step1: {
      ...
      identifierRequired: "MwSt-Nummer oder UID erforderlich",
    },
    step2: {
      ...
      vatMethod: "Abrechnungsmethode",
      vatInterval: "Abrechnungsintervall",
      flatRate: "Pauschalsatz",
      chartStatus: "{count} aktive Konten",
      bankStatus: "{count} Bankkonten konfiguriert",
      importChart: "Kontenplan importieren",
      manageBank: "Bankkonten verwalten",
      fiscalYear: "Gesch\u00e4ftsjahr beginnt im",
      costCenters: "Kostenstellen aktivieren",
      projects: "Projekte aktivieren",
      useBanana: "Banana als Buchhaltungssystem",
      chartInsufficient: "Mindestens 10 Konten erforderlich",
    },
    readiness: {
      title: "Modul-Readiness",
      modules: {
        stammdaten: "Stammdaten", belege: "Belege", lieferanten: "Lieferanten",
        kontenplan: "Kontenplan", bank: "Bank", mwst: "MwSt",
        vertraege: "Vertr\u00e4ge", expected_docs: "Erwartete Belege",
        banana: "Banana", autopilot: "Autopilot",
      },
      levels: {
        not_started: "Nicht begonnen", partial: "Teilweise", manual_ok: "Manuell betreibbar",
        suggestions_ready: "Vorschl\u00e4ge m\u00f6glich", prefill_ready: "Vorausf\u00fcllung m\u00f6glich",
        shadow_ready: "Beobachtungsmodus m\u00f6glich", auto_ready: "Automatisierung m\u00f6glich",
      },
    },
    knownUnknowns: {
      title: "Offene Fragen", open: "Offen", resolved: "Geklärt",
      blocker: "Blockiert Go-Live", area: "Bereich", criticality: "Kritikalität",
    ...
    step6: {
      ...
      unknowns: {
        title: "Offene Fragen",
        open: "{count} offen",
        blockerCount: "{count} blockieren Go-Live",
        resolve: "Geklärt",
        accept: "Akzeptieren",
        defer: "Zurückstellen",
        noUnknowns: "Keine offenen Fragen",
        resolvedAt: "Geklärt am {date}",
      },
      goLiveBlocked: "Go-Live noch nicht möglich",
      goLiveReady: "Bereit für Go-Live — weiter zum letzten Schritt",
    },
    step4: {
      title: "Gesch\u00e4ftsmodell erkl\u00e4ren",
      description: "Beantworten Sie gezielte Fragen \u2014 das System lernt daraus Ihr Gesch\u00e4ft",
      ...
      extractedInsights: "Erkannte Informationen",
      emptyTitle: "Keine verwertbaren Erkenntnisse erkannt",
      emptyDescription: "Die Antwort wurde gespeichert, aber es konnten keine belastbaren Erkenntnisse extrahiert werden.",
      degradedTitle: "KI-Auswertung derzeit nicht verf\u00fcgbar",
      degradedDescription: "Die Analyse konnte nicht abgeschlossen werden. Die Antwort wurde noch nicht gespeichert.",
      answerNotSaved: "Ihre Antwort wurde nicht gespeichert. Bitte versuchen Sie die Analyse erneut oder \u00fcberspringen Sie die Frage bewusst.",
      retryAnswer: "Erneut versuchen",
      historyTitle: "Bisherige Antworten",
      rulesDetected: "{count} Regel-Vorschl\u00e4ge erkannt",
      knowledgeDetected: "{count} Wissenseintr\u00e4ge erkannt",
      noInsightsDetected: "Keine Erkenntnisse erkannt",
      reason: "Warum diese Frage?",
      categories: {
        revenue: "Umsatz & Gesch\u00e4ftsmodell",
        costs: "Kosten & Aufwand",
        suppliers: "Lieferanten",
        special_cases: "Sonderf\u00e4lle",
        vat: "MwSt-Besonderheiten",
        contracts: "Vertr\u00e4ge",
        deadlines: "Fristen",
        platforms: "Plattformen",
      },
      insightTypes: {
        revenue_model: "Gesch\u00e4ftsmodell",
        typical_cost: "Typische Kosten",
        critical_supplier: "Wichtiger Lieferant",
        special_case: "Sonderfall",
        platform: "Plattform",
        deadline: "Frist",
        risk: "Risikofaktor",
        vat_special: "MwSt-Besonderheit",
      },
      unknownsResolved: "{count} offene Fragen gekl\u00e4rt",
      newUnknowns: "{count} neue Unsicherheiten erkannt",
      noMoreQuestions: "Keine weiteren Fragen n\u00f6tig \u2014 weiter zum n\u00e4chsten Schritt",
    },
    step5: {
      title: "Intelligenz pr\u00fcfen",
      description: "Pr\u00fcfen Sie die vom System erkannten Muster und Vorschl\u00e4ge",
      bootstrapTitle: "System-Analyse",
      bootstrapDescription: "Das System analysiert Ihre Daten und generiert Vorschl\u00e4ge",
      runBootstrap: "Analyse starten",
      bootstrapRunning: "Analyse l\u00e4uft...",
      autoRules: "Automatische Regeln",
      suggestedKnowledge: "Wissenseintr\u00e4ge",
      expectedDocs: "Erwartete Belege",
      supplierDefaults: "Lieferanten-Standards",
      confirm: "Best\u00e4tigen",
      reject: "Verwerfen",
      defer: "Zur\u00fcckstellen",
      confirmed: "Best\u00e4tigt",
      ...
      summary: "{count} Vorschl\u00e4ge generiert",
      summaryAutoApplied: "{count} automatisch \u00fcbernommen",
      summaryNeedsReview: "{count} zur Pr\u00fcfung",
      actions: {
        confirmAll: "Alle best\u00e4tigen",
        rejectAll: "Alle verwerfen",
        applyConfirmed: "\u00dcbernehmen",
        acceptAllSafe: "Alle sicheren \u00fcbernehmen",
      },
      toReadiness: "Weiter zur Readiness-Pr\u00fcfung",
      noItems: "Noch keine Vorschl\u00e4ge \u2014 starten Sie die Analyse",
    },
    ...
    step3: {
      ...
      uploaded: "{current} von {recommended}",
      readyForBootstrap: "Genug Belege f\u00fcr die Muster-Analyse",
      notReady: "Noch {count} Belege aus mindestens {categories} Kategorien empfohlen",
      startBootstrap: "Muster-Analyse starten",
      bootstrapRunning: "Analyse l\u00e4uft\u2026",
    ...
    step7: {
      title: "Go-Live",
      description: "Starten Sie den kontrollierten Hochlauf in den produktiven Betrieb",
      startGoLive: "Go-Live starten",
      starting: "Starte...",
      goLiveBlocked: "Go-Live blockiert",
      recommendedConfig: "Empfohlene Konfiguration",
      autopilot: "Autopilot-Modus",
      review: "Review-Stufe",
      stabilization: "Geschätzte Stabilisierung",
      days: "Tage",
      phases: {
        go_live_started: "Go-Live gestartet",
        first_week: "Erste Woche",
      ...
      restrictedModules: "Eingeschränkte Module",
      openTasks: "Offene Aufgaben",
      openQuestions: "Offene Fragen",
      recommendations: "Empfehlungen für diese Phase",
      completed: "Onboarding abgeschlossen!",
      completedDescription: "Der Mandant ist live. Sie können über das Dashboard arbeiten.",
    ...
    goLiveWidget: {
      ...
      autopilot: "Autopilot",
      review: "Review",
      restrictedCount: "{count} Module eingeschränkt",
    },
  },
  ...
  bank: {
    ...
    readOnlyDescription: "Bankkonten und Zuordnungen sind für Ihre Rolle schreibgeschützt.",
    setupHintTitle: "Bankkonto zuerst anlegen",
    setupHintDescription: "Erstellen Sie ein Bankkonto und importieren Sie danach camt.053-Auszüge Ihrer Bank.",
    importDialogLabel: "camt.053 XML",
    importing: "Importiere…",
    importSummary: "{statements} Auszüge, {matched} zugeordnet, {unmatched} offen",
  },
  payment: {
  ...
  vatReturn: {
    ...
    xmlUnavailable: "XML-Export noch nicht verfügbar",
    xmlUnavailableHint: "Der eCH-0217-Export bleibt bis zur vollständigen fachlichen Implementierung deaktiviert.",
    documents: "Belege",
    createdAt: "Erstellt am",
    payable: "Zahllast",
    ...
    warnings: "Warnungen",
    halfYearOption1: "H1 (Jan–Jun)",
    halfYearOption2: "H2 (Jul–Dez)",
    quarterOption1: "Q1 (Jan–Mär)",
    quarterOption2: "Q2 (Apr–Jun)",
    quarterOption3: "Q3 (Jul–Sep)",
    quarterOption4: "Q4 (Okt–Dez)",
    createLoading: "Erstelle…",
  },
  email: {
    title: "E-Mail-Import",
  ...
  emailImport: {
    ...
    status: "Status",
    webhookOnlyInfo: "Der Import ist derzeit webhook-basiert. BelegPilot verbindet sich nicht direkt mit Gmail, Outlook, IMAP oder POP3.",
    attachmentTruth: "Anhänge werden als Belege angelegt. Eine fachliche Rechnungserkennung vor dem Anlegen gibt es aktuell nicht.",
    emptyHint: "Erstelle eine Inbox und leite E-Mails aus deinem Mail-System an die erzeugte Adresse oder den vorgeschalteten Webhook weiter.",
    copyAddress: "Adresse kopieren",
    labelPlaceholder: "z. B. Haupteingang Rechnungen",
    labelHint: "Eine eindeutige Empfangsadresse wird automatisch generiert.",
    creating: "Erstelle…",
    enabledShort: "An",
    disabledShort: "Aus",
    allSenders: "Alle Absender",
  ...
  integrations: {
    ...
    activationOpen: "Aktivierung offen",
    configure: "Konfigurieren",
    activationRequired: "Import erst nach aktivierter Integration verfügbar.",
    subtitle: "Importe bleiben an echte Aktivierung und Konfiguration des Providers gebunden.",
  ...
  banana: {
    ...
    introTitle: "Tipp: Banana-Export",
    introDescription: "Banana-Export erstellt Buchungsdateien im Banana-Format. Stellen Sie sicher, dass der Kontenplan gemappt ist.",
    accountLabel: "Konto",
    ...
    roundTrip: {
      ...
      importHistoryHint: "Die Historie zeigt aktuell nur aggregierte Batch-Ergebnisse. Eine Detailansicht pro Batch ist vor dem UI-Refurbish noch nicht freigegeben.",
      batch: "Batch",
      rows: "Zeilen",
